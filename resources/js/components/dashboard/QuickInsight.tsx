...
export default function QuickInsight() {
    return (
        <div className="flex flex-col justify-between rounded-[20px] bg-surface-gray p-6 shadow-rental h-full">
            <h2 className="mb-4 font-bold text-navy-blue">Ikhtisar Singkat</h2>
            ...
            <div className="mb-6 flex gap-4 rounded-[16px] bg-green-50 p-4 border border-pale-green">
                ...
                <div>
                    <p className="font-bold text-green-800">Kinerja baik.</p>
            ...
            <div className="flex flex-col gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <p className="text-xs font-semibold text-slate-gray">Bulan dengan Kinerja Terbaik</p>
                        <p className="font-bold text-navy-blue">Maret 2025</p>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <p className="text-xs font-semibold text-slate-gray">Penyewaan Tertinggi</p>
                        <p className="font-bold text-navy-blue">151 Penyewaan</p>
                    </div>
                </div>
            </div>
        </div>
