...
export default function ShuttleOrderCreate({ tariffs }: { tariffs: ShuttleTariff[] }) {
    ...
    return (
        <>
            <Head title="Pesan Antar-Jemput - URBAN 8" />
            <div className="min-h-screen bg-base-white p-6 text-navy-blue">
                <div className="mx-auto max-w-xl">
                    <div className="mb-6 flex items-center gap-3">
                        ...
                        <h1 className="text-2xl font-bold">Pesan Antar-Jemput</h1>
                    </div>
                    ...
                    <div className="mb-6 grid gap-3 sm:grid-cols-2">
                        {tariffs.map((t) => (
                            ...
                            >
                                ...
                                <p className="mt-1 text-xs text-slate-gray">{t.estimated_distance_km} km - {t.estimated_duration_minutes} menit</p>
                    ...
                    <div className="rounded-[24px] bg-surface-gray p-8 shadow-rental">
                        <form onSubmit={submit} className="flex flex-col gap-5">
                            <div>
                                <label className="mb-1 block text-sm font-semibold">Alamat Penjemputan</label>
                                <textarea
                            ...
                            >
                                {processing ? 'Memproses...' : 'Buat Pesanan Antar-Jemput'}
                            </button>
                        </form>
                    </div>
                </div>
