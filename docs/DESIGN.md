# URBAN 8 — Design System Reference

> Premium Vehicle Rental

**Theme:** light

**Brand:** URBAN 8 (formerly FleetGo). Logo: `public/images/logo/logo-urban8.png`. The design employs a premium, business-friendly aesthetic combining a Navy Blue primary with Amber Gold accent. Typography mixes a robust display font for headings with a clean sans-serif for readability. Components favor rounded edges (12px–24px radius) and subtle shadows, maintaining a refined, approachable feel suitable for vehicle rental SaaS.

## 🎨 Color Palette

| Color Palette     | Hex       | Kedudukan di Design System |
| :---------------- | :-------- | :------------------------- |
| **Navy Blue**     | `#0f172a` | Primary                    |
| **Amber Gold**    | `#f59e0b` | Accent / Warning           |
| **Pale Amber**    | `#fffbeb` | Warning Background         |
| **Success Green** | `#10b981` | Success                    |
| **Pale Green**    | `#ecfdf5` | Success Background         |
| **Slate Gray**    | `#64748b` | Text Secondary             |
| **Surface Gray**  | `#f8fafc` | Surface                    |
...
:root {
    ...
    --font-champ:
        'Champ', ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont,
